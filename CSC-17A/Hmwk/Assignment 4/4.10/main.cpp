...
int main() {
    int feet, inches; // To hold input for feet and inches 10
    ...
    //Compare two objects
    if(first == second) {
        cout << "The two length are same." << endl;
    } else if (first <= second) {
        cout << "The first length is shorter than the second one." << endl;
    } else if (first >= second) {
        cout << "The first length is longer than the second one." << endl;
    }
